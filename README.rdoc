...
* **WHERE LEFT OFF:** Started creating a separate location table for Regions. Added latitude and longitude to Sightings table. Must refactor all location files to reflect these changes.
